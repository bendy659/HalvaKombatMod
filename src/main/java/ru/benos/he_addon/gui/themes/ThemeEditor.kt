...
import ru.benos.he_addon.gui.themes.ThemeSelect.THEMEDIR
import ru.benos.he_addon.gui.themes.ThemeSelect.getSelectTheme
...
object ThemeEditor: HollowScreen() {
  ...
  private val bg0 = loadTheme(getSelectTheme(), "bg0")
  private val bg1 = loadTheme(getSelectTheme(), "bg1")
